...
@Injectable()
export class TemperatureHumiditySensorService extends CrudService<any, number> {

  constructor(http: Http) {
    super(BASE_API_URL + "component/temperature-humidity", http, REQUEST_OPTIONS_DEFAULT)
  }
